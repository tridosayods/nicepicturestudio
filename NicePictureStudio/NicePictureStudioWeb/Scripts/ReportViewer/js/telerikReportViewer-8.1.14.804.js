/*
* TelerikReporting v8.1.14.804 (http://www.telerik.com/products/reporting.aspx)
    ...
    function ReportViewerController(options) {
        ...
        $.extend(controller, {
            ...
            serverActionStarted: function() {
                return eventFactory("trv.SERVER_ACTION_STARTED", arguments);
            }
        });
        return controller;
    }
...
(function(trv, $, window, document, undefined) {
    ...
    function uiController(options) {
        ...
        function updateUICore() {
            ...
            $controller.trigger("trv.UPDATE_UI", null);
            try {
...
(function(trv, $, window, document, undefined) {
    ...
    function ReportViewer(dom, options) {
        ...
        function init() {
            ...
            function eventBinder(eventName, additionalArguments, eventHandler) {
                if (typeof eventHandler == "function") {
                    $(controller).on(eventName, additionalArguments, eventHandler);
                }
            }
            eventBinder("trv.EXPORT_STARTED", null, options.exportBegin);
            eventBinder("trv.EXPORT_DOCUMENT_READY", null, options.exportEnd);
            eventBinder("trv.PRINT_STARTED", null, options.printBegin);
            eventBinder("trv.PRINT_DOCUMENT_READY", null, options.printEnd);
            eventBinder("trv.BEGIN_LOAD_REPORT", null, options.renderingBegin);
            eventBinder("trv.REPORT_LOAD_COMPLETE", null, options.renderingEnd);
            eventBinder("trv.PAGE_READY", null, options.pageReady);
            eventBinder("trv.ERROR", null, options.error);
            eventBinder("trv.UPDATE_UI", {
                viewer: viewer
            }, options.updateUi);
            eventBinder("trv.TOGGLE_SIDE_MENU", null, function() {
                window.setTimeout(function() {
...
/* DO NOT MODIFY OR DELETE THIS LINE! UPGRADE WIZARD CHECKSUM 06037FEB339423A965340A2B2E138767 */